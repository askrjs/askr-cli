        ...
        <section class="page-header chart-page">
          <div class="page-header-copy">
            ...
            <p class="marketing-lead text-muted">
              Switch the dataset and animation state to see the same page update without turning
              into a chart catalog.
            </p>
          </div>
        </section>
      </Section>
        ...
        <Card class="chart-toolbar" variant="raised">
          ...
          <CardContent class="chart-toolbar__body">
            <div class="chart-toggle-row">
              ...
              <Toggle pressed={animate()} onPress={() => animate.set((value) => !value)}>
                Animate
              </Toggle>
            </div>
